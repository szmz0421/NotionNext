...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || truth, // 是否显示切换主题按钮
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lana', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '及时记录', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.szmz.blog', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Life', // 网站关键词 英文逗号隔开
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/afiretre', // 您的instagram地址
